...
class DeterminationViewController<Content> : UIHostingController<Content> where Content : View {
    ...
    override init(rootView: Content) {
        ...
        m_Mantras.append(Mantra.createMany(number: 5, title: "Feed yourself", text: "When are you going to finish making salsa?"))
        m_Mantras.append(Mantra.createMany(number: 5, title: "Finish taxes", text: "What is the next step to finishing Chloe's taxes?"))
        m_Mantras.append(Mantra.createMany(number: 5, title: "Car registration", text: "When are you going to reschedule and add emissions for the inspection"))
        ...
        m_Mantras.append(Mantra.createMany(number: 5, title: "Get yourself organized!", text: "What is the next step to organizing the bathroom dresser?"))
        m_Mantras.append(Mantra.createMany(number: 5, title: "Cleaning floors", text: "When are you going to finish mopping the floors?"))
        ...
        m_Mantras.append(Mantra.createMany(number: 5, title: "You're a clean boy!", text: "When will you finish cleaning the shower?"))
