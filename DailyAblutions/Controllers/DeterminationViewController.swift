...
class DeterminationViewController<Content> : UIHostingController<Content> where Content : View {
    ...
    override init(rootView: Content) {
        ...
        m_Mantras.append(Mantra.createMany(number: 5, title: "Finish taxes", text: "What is the next step to finishing taxes?"))
        m_Mantras.append(Mantra.createMany(number: 5, title: "Car registration", text: "What is the next step taking care of the car? Make a plan"))
