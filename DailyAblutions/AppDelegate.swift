...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func HandleAppRefresh(task: BGAppRefreshTask) {
        ...
        let operation = BlockOperation(block: {
            ...
            mantras.append(Mantra.createMany(number: 5, title: "Code activism into your environment", text: "How will you call your family to action?"))
            ...
            mantras.append(Mantra.createMany(number: 5, title: "You are forged in flame", text: "You've been in a war for control of your life. Fight back."))
